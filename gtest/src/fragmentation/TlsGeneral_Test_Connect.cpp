...
Fragmentation_TlsGeneral_Test_Connect::Fragmentation_TlsGeneral_Test_Connect() {}
Fragmentation_TlsGeneral_Test_Connect::~Fragmentation_TlsGeneral_Test_Connect() {}

void Fragmentation_TlsGeneral_Test_Connect::SetUp()
{
    // Get free TLS port
...
void Fragmentation_TlsGeneral_Test_Connect::TearDown()
{
...
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, PosTest_MainCerts)
{
...
// Exp Result: NETWORKLISTENER_START_OK, NETWORKCLIENT_START_OK
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, PosTest_SecondCerts)
{
...
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, NegTest_ClientWithSelfSignedCert)
{
    EXPECT_EQ(tlsServer.start(port, KeyPaths::CaCert, KeyPaths::ListenerCert, KeyPaths::ListenerKey), NETWORKLISTENER_START_OK);
...
// Exp Result: NETWORKLISTENER_START_OK, NETWORKCLIENT_ERROR_START_CONNECT_INIT
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, NegTest_ClientWithUnknownCa)
{
    EXPECT_EQ(tlsServer.start(port, KeyPaths::CaCert, KeyPaths::ListenerCert, KeyPaths::ListenerKey), NETWORKLISTENER_START_OK);
...
// Exp Result: NETWORKLISTENER_START_OK, NETWORKCLIENT_ERROR_START_CONNECT_INIT
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, NegTest_ClientWithCertChainDepth2)
{
    EXPECT_EQ(tlsServer.start(port, KeyPaths::CaCert, KeyPaths::ListenerCert, KeyPaths::ListenerKey), NETWORKLISTENER_START_OK);
...
// Exp Result: NETWORKLISTENER_START_OK, NETWORKCLIENT_ERROR_START_CONNECT_INIT
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, NegTest_ServerWithSelfSignedCert)
{
...
// Exp Result: NETWORKLISTENER_START_OK, NETWORKCLIENT_ERROR_START_CONNECT_INIT
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, NegTest_ServerWithUnknownCa)
{
...
// Exp Result: NETWORKLISTENER_START_OK, NETWORKCLIENT_ERROR_START_CONNECT_INIT
// ====================================================================================================================
TEST_F(Fragmentation_TlsGeneral_Test_Connect, NegTest_ServerWithCertChainDepth2)
{
