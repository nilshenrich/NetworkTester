...
TlsGeneral_Test_MsgTransfer::TlsGeneral_Test_MsgTransfer() {}
TlsGeneral_Test_MsgTransfer::~TlsGeneral_Test_MsgTransfer() {}

void TlsGeneral_Test_MsgTransfer::SetUp()
{
    // ==============================================
...
void TlsGeneral_Test_MsgTransfer::TearDown()
{
...
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, PosTest_ClientToServer_NormalMsg)
{
...
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, PosTest_ServerToClient_NormalMsg)
{
...
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, PosTest_ClientToServer_MaxLen)
{
...
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, NegTest_ClientToServer_ExceedMaxLen_OnRec)
{
...
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, NegTest_ClientToServer_ExceedMaxLen_OnSend)
{
    // Generate message with max elements of ASCII characters 33 - 126
    string msg;
    for (size_t i = 0; i < TestConstants::MAXLEN_MSG_SHORT_B + 1; i += 1)
...
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, PosTest_ServerToClient_MaxLen)
{
    // Generate message with max elements of ASCII characters 33 - 126
    string msg;
    for (size_t i = 0; i < TestConstants::MAXLEN_MSG_SHORT_B; i += 1)
...
// Exp Result: Message sent but not received
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, NegTest_ServerToClient_ExceedMaxLen_OnRec)
{
    // Generate message with max elements of ASCII characters 33 - 126
    string msg;
    for (size_t i = 0; i < TestConstants::MAXLEN_MSG_SHORT_B + 1; i += 1)
...
// Exp Result: Message not sent
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, NegTest_ServerToClient_ExceedMaxLen_OnSend)
{
    // Generate message with max elements of ASCII characters 33 - 126
    string msg;
    for (size_t i = 0; i < TestConstants::MAXLEN_MSG_SHORT_B + 1; i += 1)
...
// Exp Result: Message received by server
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, PosTest_ClientToServer_LongMsg)
{
...
// Exp Result: Message received by client
// ====================================================================================================================
TEST_F(TlsGeneral_Test_MsgTransfer, PosTest_ServerToClient_LongMsg)
{
    // Generate message with 1000000 elements of ASCII characters 33 - 126
    string msg;
    for (size_t i = 0; i < 1000000; i += 1)
